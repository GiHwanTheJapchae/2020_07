...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as client_socket:
    ...
    print("Turning angle and move forward")  # point A to B
    set_attitude(pitch_angle=-5, thrust=0.5, duration=0.7)
...
"""
    ...
    print("Turning angle and move forward")  # point B to C
    ...
    print("Turning angle and move forward")  # point C to D
    set_attitude(yaw_angle=135, pitch_angle=-5, thrust=0.5, duration=0.7)
    ...
    print("Turning angle and move forward")  # point D to E
    set_attitude(yaw_angle=180, pitch_angle=-5, thrust=0.5, duration=0.7)
    ...
    print("Turning angle and move forward")  # point E to A
