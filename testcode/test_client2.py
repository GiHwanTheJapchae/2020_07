...
set_attitude(pitch_angle=-5, yaw_angle=45, thrust=0.5, duration=1)
print("Setting LAND mode...")
vehicle.mode = VehicleMode("LAND")
time.sleep(1)
print("Close vehicle object")
...
set_attitude(yaw_angle=135, pitch_angle=-5, thrust=0.5, duration=2)
print("Setting LAND mode...")
vehicle.mode = VehicleMode("LAND")
time.sleep(1)
print("Close vehicle object")
...
set_attitude(yaw_angle=270, pitch_angle=-5, thrust=0.5, duration=2)
print("Setting LAND mode...")
vehicle.mode = VehicleMode("LAND")
time.sleep(1)
print("Close vehicle object")
